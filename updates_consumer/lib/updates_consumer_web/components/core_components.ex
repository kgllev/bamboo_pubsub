defmodule UpdatesConsumerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(UpdatesConsumerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(UpdatesConsumerWeb.Gettext, "errors", msg, opts)
    end
  end
